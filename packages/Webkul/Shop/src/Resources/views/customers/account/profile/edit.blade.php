            ...
            <x-shop::form
                ...
                <x-shop::form.control-group>
                    ...
                    <div class="relative" x-data="{ showCurrentPassword: false }">
                        ...
                        <button
                            type="button"
                            @click="showCurrentPassword = !showCurrentPassword;$event.target.closest('.relative').querySelector('input[name=current_password]').type = showCurrentPassword ? 'text' : 'password';"
                            class="absolute top-1/2 right-4 -translate-y-1/2 text-zinc-500">
                            <span x-show="!showCurrentPassword" class="icon-eye text-2xl"></span>
                            <span x-show="showCurrentPassword" class="icon-eye-slash text-2xl"></span>
                        </button>
                    </div>
                ...
                <x-shop::form.control-group>
                    ...
                    <div class="relative" x-data="{ showNewPassword: false }">
                        ...
                        <button
                            type="button"
                            @click="showNewPassword = !showNewPassword;$event.target.closest('.relative').querySelector('input[name=new_password]').type = showNewPassword ? 'text' : 'password';"
                            class="absolute top-1/2 right-4 -translate-y-1/2 text-zinc-500">
                            <span x-show="!showNewPassword" class="icon-eye text-2xl"></span>
                            <span x-show="showNewPassword" class="icon-eye-slash text-2xl"></span>
                        </button>
                    </div>
                ...
                <x-shop::form.control-group>
                    ...
                    <div class="relative" x-data="{ showNewPasswordConfirmation: false }">
                        <x-shop::form.control-group.control
                            type="password"
                            class="pr-12"
                            name="new_password_confirmation"
                        ...
                        <button
                            type="button"
                            @click="showNewPasswordConfirmation = !showNewPasswordConfirmation;$event.target.closest('.relative').querySelector('input[name=new_password_confirmation]').type = showNewPasswordConfirmation ? 'text' : 'password';"
                            class="absolute top-1/2 right-4 -translate-y-1/2 text-zinc-500">
                            <span x-show="!showNewPasswordConfirmation" class="icon-eye text-2xl"></span>
                            <span x-show="showNewPasswordConfirmation" class="icon-eye-slash text-2xl"></span>
                        </button>
                    </div>
