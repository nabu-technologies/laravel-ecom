    ...
    <x-slot:title>
        ...
        <div class="container mt-20 max-1180:px-5 max-md:mt-12">
            ...
            <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
                ...
                <div class="mt-14 rounded max-sm:mt-8">
                    ...
                    <x-shop::form :action="route('shop.customers.reset_password.store')">
                        ...
                        <x-shop::form.control-group.control
                            ...
                            class="px-6 py-4 max-md:py-3 max-sm:py-1.5"
                            name="password"
                            rules="required|min:6|apphas:lowercase,uppercase,digit,special"
                            value=""
                        ...
                        <x-shop::form.control-group class="mb-6">
                            ...
                            <div class="relative" x-data="{ showPassword: false }">
                                <x-shop::form.control-group.control
                                    type="password"
                                    class="px-6 py-4 max-md:py-3 max-sm:py-1.5 pr-12"
                                    name="password"
                ...
                $event.target.closest('.relative').querySelector('input[name=password]').type = showPassword ? 'text' : 'password';
            "
