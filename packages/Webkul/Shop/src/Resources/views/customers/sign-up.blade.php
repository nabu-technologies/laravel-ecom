...
<x-shop::layouts
    ...
    <x-slot:title>
        ...
        <div class="container mt-20 max-1180:px-5 max-md:mt-12">
            ...
            <!-- Form Container -->
            <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0 font-sans">
                <h1 class="font-sans font-bold text-4xl max-md:text-3xl max-sm:text-xl">
                    @lang('shop::app.customers.signup-form.page-title')
                </h1>
                    ...
                    <x-shop::form :action="route('shop.customers.register.store')">
                        ...
                        <x-shop::form.control-group class="mb-6">
                            ...
                            <div class="relative" x-data="{ showPassword: false }">
                                <x-shop::form.control-group.control
                                    type="password"
                                    class="px-6 py-4 max-md:py-3 max-sm:py-2 pr-12"
                                    name="password"
                                    rules="required|min:6"
                                    :value="old('password')"
                                    :label="trans('shop::app.customers.signup-form.password')"
                                ...
                                <button
                                    type="button"
                                    @click="showPassword = !showPassword;$event.target.closest('.relative').querySelector('input[name=password]').type = showPassword ? 'text' : 'password';"
                                    class="absolute top-1/2 right-4 -translate-y-1/2 text-zinc-500">
                                    <span x-show="!showPassword" class="icon-eye text-2xl"></span>
                                    <span x-show="showPassword" class="icon-eye-slash text-2xl"></span>
                                </button>
                            </div>
                        </x-shop::form.control-group>
                        ...
                        <x-shop::form.control-group>
                            ...
                            <div class="relative" x-data="{ showConfirmPassword: false }">
                                ...
                                <button
                                    type="button"
                                    @click="showConfirmPassword = !showConfirmPassword;$event.target.closest('.relative').querySelector('input[name=password_confirmation]').type = showConfirmPassword ? 'text' : 'password';"
                                    class="absolute top-1/2 right-4 -translate-y-1/2 text-zinc-500">
                                    <span x-show="!showConfirmPassword" class="icon-eye text-2xl"></span>
                                    <span x-show="showConfirmPassword" class="icon-eye-slash text-2xl"></span>
                                </button>
                            </div>
