...
<div style=" font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; margin-bottom: 34px;">
    ...
    <div style="font-size:16px; color:#4B5563; line-height:1.7;">
        ...
        <p style="margin:0 0 12px;">
            Your purchased document is now available for download from your account.
        </p>

        <p style="margin:0 0 6px;">
            You can access it by logging in to your profile and navigating to:
        </p>

        <p style="margin:0 0 14px; font-weight:600; color:#111827;">
            User Profile → Downloadable Products
        </p>
        ...
        <p style="margin:0 0 12px;">
            Our team will contact you shortly regarding the next steps and any further proceedings related to your purchase.
        </p>

        <p style="margin:0;">
            Need help?
            Contact us at
            <a href="mailto:care@nabu.co.in"
                style="color:#2563EB; text-decoration:none;">
                care@nabu.co.in
            </a>
        </p>
...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 20px;font-weight: 600;color: #121A26">
    @lang('shop::app.emails.orders.invoiced.summary')
</div>

<div style=" font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
...
<div style=" font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; padding-bottom: 40px;border-bottom: 1px solid #CBD5E1;">
...
<div style=" font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;display: grid;justify-content: end;font-size: 16px;color: #384860;line-height: 30px;padding-top: 20px;padding-bottom: 20px;">
