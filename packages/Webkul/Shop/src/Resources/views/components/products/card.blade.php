...
<script
    ...
    <div
        ...
        <div class="grid max-w-[291px] content-start gap-2.5 bg-white p-3.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px]">
            ...
            <p class="font-bold text-neutral-900 text-base leading-tight flex-1 truncate cursor-default">
                @{{ product.name }}
            </p>
            ...
            <!-- Pricing -->
            <label class="text-xs font-medium text-neutral-700">Amount</label>
            ...
            <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md ring-offset-background text-green-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 px-4 py-2 w-full h-12 font-semibold text-base transition-all duration-200 bg-brand-green shadow-lg hover:shadow-xl"
                :href="'{{ route('shop.product_or_category.index', ':slug') }}'.replace(':slug', product.url_key)"
    ...
    <div
        ...
        <div class="grid content-start gap-4">
            ...
            <button
                ...
                :disabled="! product.is_saleable || isAddingToCart"
                @click="addToCart()">
                @{{ (product.type === 'configurable' || product.type === 'downloadable') ? 'View Product' : '@lang('shop::app.components.products.card.add-to-cart')' }}View Product
            </button>
...
<script type="module">
    app.component('v-product-card', {
        ...
        methods: {
            ...
            addToCart() {
                if (this.product.type === 'configurable' || this.product.type === 'downloadable') {
